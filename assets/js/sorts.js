...
const chooseAmountBtn = document.getElementById("choose_amount");    
    ...
    /*---------------------- Box Class Declaration ---------------------- */
        class box {
            ...
            create_box = ()=> {
                ...
                ctx.fillText(`${this.height}`, this.x +(GAP), y_height+10,[this.width-GAP] );
            ...
            update = (new_x)=> {
                if(new_x > this.x){ 
                    this.x = (this.x+this.dx) > new_x ? this.x+(new_x-this.x): this.x+this.dx;
                    return false;                                                 
                }         
    ...
    /*---------------------- Generates Array ---------------------- */
        ...
        const create_items = (amount_boxes) =>{
            ...
            let box_width;
            if (((amount_boxes * PREFERRED_WIDTH) + (amount_boxes * GAP)) > pixel_remaining) {
                ...
                const empty_space = (pixel_remaining - ((box_width * amount_boxes) + gap_space)) / amount_boxes;
    ...
    /*---------------------- Sort Helper Methods ---------------------- */
        ...
        const set_scanning_color = (index,s_start,s_end) => {
            ...
            if(!cb_mode)
                arr[index].color = box_colors_original[1];
            else {
                 arr[index].color = '#000'
            }
            ctx.clearRect(0, 0, inner_width, inner_height);
        ...
        function bubble_sort()
        {
            ...
            function main(){
                ...
                if(inSwap)
                {
                    ...
                    main_message.innerHTML= `Swapping ${arr[index].height} with ${arr[index+1].height}!`;
                    //update boxes
        ...
        function selection_sort() {
            ...
            function main() {
                ...
                function check_if_swap() {
                    ...
                    if (index === arr.length - 1 || arr[index].height < arr[smallest].height) {
